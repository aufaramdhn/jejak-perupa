...
export const defaultAboutPillars: PlatformPillarItem[] = [
  {
    id: "pillar-1",
    number: "01",
...
export const defaultMascotSlides: MascotSlideItem[] = [
  {
    id: "slide-1",
...
export const defaultPeruChanQuotes: PeruChanQuoteItem[] = [
  {
    id: "quote-1",
...
export const siteSettingsSeeder: SiteSettingsData = {
  ...
  mascotSlides: defaultMascotSlides,
  quotes: defaultPeruChanQuotes,
};
